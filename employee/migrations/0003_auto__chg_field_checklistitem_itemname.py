...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ChecklistItem.itemname'
        db.alter_column('employee_checklistitem', 'itemname', self.gf('django.db.models.fields.CharField')(max_length=200))


    def backwards(self, orm):
        
        # Changing field 'ChecklistItem.itemname'
        db.alter_column('employee_checklistitem', 'itemname', self.gf('django.db.models.fields.CharField')(max_length=100))
