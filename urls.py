...
from checklist.employee.views import indexview, employeeview, employeelist, update_employeeinfo, update_employeelist, new_employee, toggle_state_employee
from checklist.editlist.views import edit_lists, edit_list, edit_list_item
