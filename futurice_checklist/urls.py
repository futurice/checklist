...
urlpatterns = patterns('',
    ...
    url(r'^reminders/create$', remindercreate, kwargs={"template_name": "edit.html"}),
    url(r'^reminders/edit/(?P<list_id>[0-9]+)$', reminderedit, kwargs={"template_name": "edit.html"}),
    url(r'^reminders/delete/(?P<list_id>[0-9]+)$', reminderdelete, kwargs={"template_name": "reminders/delete.html"}),
